...
from collections.abc import AsyncGenerator, AsyncIterable, AsyncIterator, Callable, Iteratorfrom contextlib import asynccontextmanager, contextmanager
...
class AnthropicModel(Model[AsyncAnthropicClient]):
    ...
    async def _messages_create(
        ...
        context_management = self._add_compaction_params(messages, betas, model_settings)        with _map_api_errors(self.model_name):

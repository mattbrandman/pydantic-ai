    ...
    async def request(
        ...
        if info := self._get_continuation_info(messages, settings):
            ...
            response = await self._responses_create(
                messages, False, settings, model_request_parameters, code_execution_context,
            )
        ...
        return self._process_response(
            response, settings, model_request_parameters, code_execution_context=code_execution_context,
        )
        ...
        if info := self._get_continuation_info(messages, settings):
            ...
            if last_sequence_number is None:
                ...
                yield _ModelResponseStreamedResponse(
                    model_request_parameters=model_request_parameters,
                    _model_response=self._process_response(
                        response, settings, model_request_parameters,
            ...
            response = await self._responses_create(
                messages, True, settings, model_request_parameters, code_execution_context,
            )
        if isinstance(response, ModelResponse):
            yield _ModelResponseStreamedResponse(
                model_request_parameters=model_request_parameters,

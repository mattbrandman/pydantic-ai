...
from ..tools import AgentDepsT, ToolDefinitionfrom . import (
    Model,
    ModelRequestContext,
...
try:
    ...
    from openai.types.responses.response_compaction_item_param_param import ResponseCompactionItemParamParam    from openai.types.responses.response_input_file_content_param import ResponseInputFileContentParam
